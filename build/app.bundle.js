...
var TodoList = function TodoList(props) {
    return _react2.default.createElement(
        ...
        props.data.map(function (listValue) {
            return _react2.default.createElement(
                'li',
                { className: _TodoList2.default.TodoItem, key: listValue.id, onClick: function onClick() {
                        return props.remove(listValue.id);
                    } },
                listValue.text
            );
        })
